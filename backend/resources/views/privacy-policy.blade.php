...
<head>
    ...
    <title>Privacy Policy | EMZI Calendar</title>
    <style>
        :root {
            --bg: #f5f7fb;
            --card: #ffffff;
...
<body>
    <main class="container">
        <article class="card">
            ...
            <h2>Introduction</h2>
            <p>This Privacy Policy explains how EMZI Calendar ("we", "our", or "us") collects, uses, and protects information when you use our application and services.</p>
            ...
            <p>Email: <a href="mailto:it@emzi.com.my">it@emzi.com.my</a></p>
            <p>Website: <a href="https://brain.groobok.com" target="_blank" rel="noopener noreferrer">https://brain.groobok.com</a></p>
        </article>
    </main>
</body>
</html>
