...
export default function Register() {
  ...
  return (
    <div className="flex min-h-screen min-w-0 max-w-full overflow-x-hidden">
      ...
      <div className="relative flex flex-1 flex-col items-center justify-between overflow-y-auto bg-[hsl(206,92%,15%)] px-6 pb-8 pt-[calc(2rem+var(--nexus-safe-top))] lg:justify-center lg:bg-background lg:py-12">
