          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-start">
            ...
            <div className="min-w-0 flex-1 space-y-4">
              ...
              {userSection === 'notifications' ? (
                <div className="space-y-4 pb-[calc(10rem+var(--nexus-safe-bottom))] sm:pb-0">
                  <Card className="rounded-2xl">
                    <CardHeader className="pb-3">
                      <CardTitle className="text-base flex items-center gap-2">
                  ...
                  <div className="sticky bottom-[var(--nexus-dock-clearance)] z-30 -mx-1 rounded-2xl border bg-background/95 p-3 shadow-lg backdrop-blur supports-[backdrop-filter]:bg-background/80 sm:static sm:mx-0 sm:border-0 sm:bg-transparent sm:p-0 sm:shadow-none sm:backdrop-blur-none sm:z-auto">
