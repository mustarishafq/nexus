...
import { formatRichTextWithMentions, looksLikeHtml, RICH_TEXT_CONTENT_CLASS } from '@/lib/richText';
  ...
  if (looksLikeHtml(text)) {
    return (
      <div
        ...
        dangerouslySetInnerHTML={{ __html: formatRichTextWithMentions(text) }}
      />
    );
  }

  return <PlainMentionText text={text} className={className} />;
}
