...
export function createMentionChip(userId, label) {
  ...
  chip.className =
    'mention-chip mx-0.5 inline-flex max-w-[min(100%,11rem)] items-center truncate align-middle rounded-md bg-primary/10 px-1.5 py-0.5 text-xs font-medium text-primary';
